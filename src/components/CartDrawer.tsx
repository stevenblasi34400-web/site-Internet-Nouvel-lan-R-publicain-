  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button variant="outline" size="icon" className="relative" aria-label="Ouvrir le panier">
                ...
                <div className="space-y-4">
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-2">
                      <div className="h-20 w-16 flex-shrink-0 overflow-hidden rounded-md bg-secondary/40">
              ...
              <div className="flex-shrink-0 space-y-4 border-t bg-background pt-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xl font-bold text-primary">
                    {formatPrice(String(totalPrice), items[0]?.price.currencyCode || "EUR")}
                  </span>
                </div>
                <Button
