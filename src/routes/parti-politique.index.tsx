...
export const Route = createFileRoute("/parti-politique/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Découvrez le mouvement politique fondé par Steven Blasi : valeurs, programme et comment nous rejoindre." },
      { property: "og:title", content: "Le mouvement politique — Steven Blasi" },
      { property: "og:description", content: "Valeurs, programme et engagement du mouvement fondé par Steven Blasi." },
  ...
  return (
    <div className="container-site py-14 md:py-20">
      <div className="max-w-3xl">
        <h2 className="heading-hero text-3xl md:text-4xl">Pourquoi ce mouvement ?</h2>
        <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
          Parce que l'écriture pose des questions, mais que seule l'action collective y
          répond. Ce mouvement est né d'une conviction simple : la politique redevient
          utile quand elle part du terrain, des commerces, des écoles, des villages.
        </p>
        <p className="mt-4 leading-relaxed text-muted-foreground">
          Le nom officiel du parti, son histoire et ses textes fondateurs seront publiés
          ici prochainement — cette section est en cours de rédaction avec l'équipe.
        </p>
      </div>
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-3">
        ...
        <div className="card-hover rounded-xl border bg-card p-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
            Écouter d'abord, proposer ensuite. Des réunions publiques régulières sur tout
            le territoire.
          </p>
        </div>
        <div className="card-hover rounded-xl border bg-card p-6">
